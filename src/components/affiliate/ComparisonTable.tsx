...
export function ComparisonTable({ products, specLabels }: ComparisonTableProps) {
    ...
    return (
        <div className="my-10">
            <div className="text-xl font-bold text-center mb-4 text-slate-800 flex items-center justify-center gap-2">
            ...
            <div className="overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0">
                <table className="w-full min-w-[800px] border-collapse text-base text-slate-700 shadow-sm rounded-none md:rounded-2xl overflow-hidden border-y md:border border-slate-200">
                    <thead>
