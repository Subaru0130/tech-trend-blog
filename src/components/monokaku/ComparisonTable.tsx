                                ...
                                <tr key={product.id} className="group hover:bg-gray-50 transition-colors">
                                    <td className="p-5 sticky left-0 bg-white group-hover:bg-gray-50 transition-colors shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] z-10">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-6 h-6 rounded-full text-white flex items-center justify-center text-xs font-bold shadow-sm ${product.rank === 1 ? 'bg-yellow-400' :
                                    ...
                                    <td className="p-5 text-center">
                                        <div className={`inline-flex items-center gap-1 text-xs font-bold px-2 py-1 rounded ${product.noiseCancelingRank === 'S' ? 'text-green-700 bg-green-50' : 'text-blue-700 bg-blue-50'
                                            }`}>
