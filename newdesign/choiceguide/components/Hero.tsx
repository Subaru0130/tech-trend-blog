          ...
          <div className="flex-1 w-full max-w-[540px] lg:max-w-none relative perspective-1000">
            <div className="relative bg-white dark:bg-gray-800 rounded-[2rem] p-4 shadow-2xl border border-gray-100 dark:border-gray-700 rotate-y-3 transform transition-transform duration-500 hover:rotate-y-0">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden relative shadow-inner">
                <img alt="Modern interior with gadgets" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCdwmDoUNhQFugaYfmqJacphz2RHCVbKLnpSE6HxVDqnoihGjnZCbMrXArUDPFdOrFuLz6mcUzJpxF2t2YvtHu5TjNA0M28YioydCJJDxKc26L7_ZG8R8wDKASscHQ_TPGrgu_JPYVsQfFEBJY-V3kJgSO1gU3ekqn_WmeA_qqT_R36baNC4Gb6xYov1CimjzWISfhJWVt0-FJd6YE1jVbZzIj1Z6JoWsImSE246f4wFLEfYxDjBG_xcYbwepLU5bbQlcoAGr-tcBo" />
                ...
                <div className="absolute bottom-6 right-6 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-xl rounded-2xl p-4 flex items-center gap-4 border border-white/20 dark:border-gray-700 max-w-[320px] animate-float">
                  <div className="size-14 rounded-xl bg-gray-100 overflow-hidden flex-shrink-0 shadow-sm">
                    <img alt="Product thumbnail" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAYMMHIRLQwYGc9sw8L4uuSCVzklDo1trPXc_VhYuPvmkDgwoCgnL7hMGR7z0l3rz9TqEbzU9jS5zTrF5pye7Vxd2Kg3GM07O2gOVGS7-LoABl_b6v3Qj7cEUeRqA8JrU72_NGQVusivZ2AMIyQh9X1uI8OpQ4cjLAmEsl4E_Qx6frbZ3IjihG6hrmVG75u-7e9XTiahsCYe5lfxV1rm5eXtg6F9HH7oBtxG7VCwtjArMvcDu3biFMoDXusBZji51N77wE071IWqqg" />
                  </div>
                  <div>
