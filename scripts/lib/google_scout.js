...
async function searchReviewSummaries(productName) {
    ...
    const query = `${productName} レビュー`;
    console.log(`\n🌍 Web Scout: Searching Bing for opinions on "${productName}"...`);
    ...
    try {
        ...
        const snippets = await page.evaluate(() => {
            ...
            document.querySelectorAll('li.b_algo').forEach(li => {
                ...
                if (title.includes("Amazon") || title.includes("Rakuten") || title.includes("楽天")) return;
